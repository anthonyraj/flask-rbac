...
--INSERT INTO "rbac_permission_inventory" VALUES(4,1,301,'AC_VIEW_APPROVED_VENORS','View approved vendors',1);
...
INSERT INTO "rbac_permission_inventory" VALUES(15,1,306,'AC_VENDOR_VIEW_ACCREDITATION_MANAGER','View accreditation manager',1,1,0);
INSERT INTO "rbac_permission_inventory" VALUES(16,1,306,'AC_VENDOR_EDIT_ACCREDITATION_MANAGER','Edit accreditation manager',2,0,0);

INSERT INTO "rbac_permission_inventory" VALUES(17,1,307,'AC_VENDOR_VIEW_COMPETENCY_MANAGER','View competency manager',1,1,0);
INSERT INTO "rbac_permission_inventory" VALUES(18,1,307,'AC_VENDOR_EDIT_COMPETENCY_MANAGER','Edit competency manager',2,0,0);
...
-- LAB PERM
INSERT INTO "rbac_permission_inventory" VALUES(151,4,450,'PROJ_LIST_VIEW','View projects list',1,0,0);
INSERT INTO "rbac_permission_inventory" VALUES(155,4,450,'PROJ_EDIT_PROJECT','Access and Edit Project',2,0,0); 
...
INSERT INTO "rbac_permission_inventory" VALUES(164,4,451,'PROJ_PROJECT_AWARD_NOTIFICATION_INAPP','Project awarded (InApp)',1,0,0);
INSERT INTO "rbac_permission_inventory" VALUES(165,4,451,'PROJ_PROJECT_AWARD_NOTIFICATION_EMAIL','Project awarded (Email)',2,0,0);

--INSERT INTO "rbac_permission_inventory" VALUES(166,4,451,'PROJ_SUPPORTING_DOCUMENT_UPLOAD_NOTIFICATION_INAPP','Supporting files submitted by customer (InApp)',2);
--INSERT INTO "rbac_permission_inventory" VALUES(167,4,451,'PROJ_SUPPORTING_DOCUMENT_UPLOAD_NOTIFICATION_EMAIL','Supporting files submitted by customer (Email)',3);

--INSERT INTO "rbac_permission_inventory" VALUES(168,4,451,'PROJ_DELIVERABLE_ACCEPTED_NOTIFICATION_INAPP','Deliverable accepted (InApp)',4);
--INSERT INTO "rbac_permission_inventory" VALUES(169,4,451,'PROJ_DELIVERABLE_ACCEPTED_NOTIFICATION_EMAIL','Deliverable accepted (Email)',5);

--INSERT INTO "rbac_permission_inventory" VALUES(170,4,451,'PROJ_PROJECT_CANCELLATION_NOTIFICATION_INAPP','Project cancelled (InApp)',6);
INSERT INTO "rbac_permission_inventory" VALUES(171,4,451,'PROJ_PROJECT_CANCELLATION_NOTIFICATION_EMAIL','Project cancelled (Email)',7,0,0);

-- END: PROJECT

-- START: RFQ
INSERT INTO "rbac_permission_inventory" VALUES(170,5,500,'RFQ_LIST_VIEW','View RFQ list',1,0,0);
INSERT INTO "rbac_permission_inventory" VALUES(171,5,500,'RFQ_EDIT_RFQ','Access and Edit RFQ',2,0,0);

-- LAB RFQ NOTIFICATIONS
INSERT INTO "rbac_permission_inventory" VALUES(172,5,501,'RFQ_REQUEST_FOR_QUOTE_NOTIFICATION_INAPP','New RFQ alert (InApp)',1,0,0);
INSERT INTO "rbac_permission_inventory" VALUES(173,5,501,'RFQ_REQUEST_FOR_QUOTE_NOTIFICATION_EMAIL','New RFQ alert (Email)',2,0,0);

INSERT INTO "rbac_permission_inventory" VALUES(174,5,501,'RFQ_QUOTE_ACCEPTED_NOTIFICATION_INAPP','Quote Accepted by customer (InApp)',3,0,0);
--INSERT INTO "rbac_permission_inventory" VALUES(175,5,501,'RFQ_QUOTE_ACCEPTED_NOTIFICATION_EMAIL','Quote Accepted by customer (Email)',4);

--INSERT INTO "rbac_permission_inventory" VALUES(176,5,501,'RFQ_EXPIRATION_NOTIFICATION_INAPP','RFQ exipration approaching (InApp)');
--INSERT INTO "rbac_permission_inventory" VALUES(177,5,501,'RFQ_EXPIRATION_NOTIFICATION_EMAIL','RFQ exipration approaching (Email)');

--INSERT INTO "rbac_permission_inventory" VALUES(178,5,501,'RFQ_PROJECT_CANCELLATION_NOTIFICATION_INAPP','RFQ cancelled by customer (InApp)');
--INSERT INTO "rbac_permission_inventory" VALUES(179,5,501,'RFQ_PROJECT_CANCELLATION_NOTIFICATION_EMAIL','RFQ cancelled by customer (Email)');

--INSERT INTO "rbac_permission_inventory" VALUES(180,5,501,'RFQ_SUPPORTING_DOCUMENT_UPLOAD_NOTIFICATION_INAPP','Supporting files submitted by customer (InApp)');
--INSERT INTO "rbac_permission_inventory" VALUES(181,5,501,'RFQ_SUPPORTING_DOCUMENT_UPLOAD_NOTIFICATION_EMAIL','Supporting files submitted by customer (Email)');

--INSERT INTO "rbac_permission_inventory" VALUES(182,5,501,'RFQ_PROJECT_NOT_AWDARDED_NOTIFICATION_INAPP','Project not awarded (InApp)');
--INSERT INTO "rbac_permission_inventory" VALUES(183,5,501,'RFQ_PROJECT_NOT_AWARDED_NOTIFICATION_EMAIL','Project not awarded (Email)');
-- END: RFQ
